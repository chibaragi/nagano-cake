...
# ここからProduct
 ...
 Product.create!(:genre_id => 2, :name => "オレンジのケーキ", :price => 500, :explanation => "甘さと酸味のコラボレーションは大人の味です。", image_id: open("./app/assets/images/cake/cats-coming-bDNxF3nzOBE-unsplash.jpeg"), :is_enabled => true)
 ...
 Product.create!(:genre_id => 4, :name => "スコーン", :price => 250, :explanation => "軽食、朝食にオススメな商品です。", image_id: open("./app/assets/images/bakegoods/eiliv-sonas-aceron-SWrk-cWJRu0-unsplash 2.jpeg"), :is_enabled => true)
 Product.create!(:genre_id => 5, :name => "シュークリーム", :price => 250, :explanation => "固めの生地とふうわりクリームで食べ応えがあります。", image_id: open("./app/assets/images/bakegoods/monika-grabkowska-xdGszqil4GI-unsplash 2.jpeg"), :is_enabled => true)
 Product.create!(:genre_id => 6, :name => "イチゴのキャンディ", :price => 150, :explanation => "甘さを長く楽しむならこれが一番です。", image_id: open("./app/assets/images/candy/mong-bui-xdJN-7PZs5o-unsplash 2.jpeg"), :is_enabled => true)
 Product.create!(:genre_id => 7, :name => "ハートのキャンディ", :price => 300, :explanation => "可愛い見た目で贈り物にもぴったり。", image_id: open("./app/assets/images/candy/amber-faust-difFvlZVYTI-unsplash 2.jpeg"), :is_enabled => true)
 Product.create!(:genre_id => 8, :name => "カスタードのプリン", :price => 250, :explanation => "ベーシックで安心する甘さをあなたに。", image_id: open("./app/assets/images/prine/alexandra-lammerink-wbSIYD-_BUc-unsplash 2.jpeg"), :is_enabled => true)
 Product.create!(:genre_id => 9, :name => "ナッツのプリン", :price => 300, :explanation => "控えめな甘さと芳醇な風味を味わってください。", image_id: open("./app/assets/images/purine/alexandra-lammerink-wbSIYD-_BUc-unsplash 2.jpeg"), :is_enabled => true)
 Product.create!(:genre_id => 10, :name => "イチゴのプリン", :price => 300, :explanation => "炭酸のジェルにしたイチゴが楽しませてくれます。", image_id: open("./app/assets/images/purine/wesual-click-BgirKolxbIk-unsplash 2.jpeg"), :is_enabled => true)
